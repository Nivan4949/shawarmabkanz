  ...
  return (
    <div className="bg-[#0E0E0E] text-[#FDFBF7] pt-28 pb-20 overflow-hidden">
      <div className="w-[90%] max-w-[1200px] mx-auto">
        ...
        <div className="max-w-[600px] mx-auto bg-[#161616] border border-white/5 rounded-2xl p-6 md:p-10 shadow-2xl relative">
            ...
            {!isSubmitted ? (
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-xs font-bold text-[#F1C40F] uppercase">
                    {t("res_name")}
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#1D1D1D] border border-white/5 rounded-lg px-4 py-3 text-sm text-[#FDFBF7] focus:outline-none focus:border-[#E61C24]"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1D1D1D] border border-white/5 rounded-lg px-4 py-3 text-sm text-[#FDFBF7] focus:outline-none focus:border-[#E61C24] appearance-none"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label className="text-xs font-bold text-[#F1C40F] uppercase">
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`p-3 rounded-lg border text-xs font-bold transition-all duration-300 ${
                            isSelected
                ...
                <button
                  type="submit"
                  className="w-full py-4 rounded-lg bg-gradient-to-r from-[#E61C24] to-[#F39C12] text-white font-bold text-center hover:shadow-[0_4px_15px_rgba(230,28,36,0.3)] transition-all duration-300"
                >
                  {t("res_submit")}
                </button>
              </motion.form>
              ...
              >
                ...
                <p className="text-sm text-white/60 mb-6 max-w-[320px] leading-relaxed">
                  {t("res_success")}
                </p>
                <button
                  onClick={() => setIsSubmitted(false)}
                  className="px-6 py-2.5 rounded-lg bg-[#1D1D1D] border border-white/10 hover:border-transparent hover:bg-[#E61C24] text-xs font-bold transition-all"
                >
