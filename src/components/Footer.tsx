      ...
      <div className="w-[90%] max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
        ...
        <div className="flex flex-col">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex gap-2">
            ...
            <button
              type="submit"
              className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#E61C24] to-[#F39C12] text-white text-sm font-bold hover:shadow-[0_2px_10px_rgba(230,28,36,0.2)] transition-all duration-300"
            >
      ...
      <div className="w-[90%] max-w-[1200px] mx-auto pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-9 h-9 rounded-full bg-white/5 flex items-center justify-center text-white/60 hover:text-white hover:bg-[#E61C24] transition-all duration-300"
          >
