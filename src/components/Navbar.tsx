  ...
  return (
    <>
      ...
      >
        ...
        {pathname === "/" && (
          <div className="bg-white border-t border-b border-neutral-200/60 shadow-sm h-12 flex items-center">
            <div className="w-[90%] max-w-[1200px] mx-auto flex items-center justify-between gap-4 h-full">
              
              {/* Scrollable Categories List */}
              <div className="flex items-center gap-1.5 overflow-x-auto scrollbar-none py-1 pr-2 w-full md:w-auto h-full">
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-md text-[10px] md:text-[11px] font-black whitespace-nowrap transition-colors ${
                        isActive
                          ? "bg-[#C41218] text-white"
                          : "bg-neutral-50 text-neutral-500 hover:bg-neutral-100 hover:text-[#C41218]"
                      }`}
                    >
                      {label}
                    </button>
