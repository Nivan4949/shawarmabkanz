        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <div className="flex justify-between relative mb-8">
              ...
              <div
                className="absolute top-4 left-6 h-[2px] bg-[#E61C24] transition-all duration-1000 z-0"
                style={{
              ...
              <div className="flex flex-col items-center gap-2 relative z-10 flex-1">
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all duration-300 ${
                    successStep >= 1
                      ? "bg-[#E61C24] border-2 border-[#E61C24] text-white shadow-[0_0_10px_#E61C24]"
            ...
            <button
              onClick={() => setIsSuccessOpen(false)}
              className="w-full py-3.5 rounded-lg bg-[#1D1D1D] hover:bg-[#E61C24] text-white font-bold transition-all duration-300 border border-white/10 hover:border-transparent"
            >
              {t("success_close")}
            </button>
          </motion.div>
